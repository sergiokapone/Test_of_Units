def get_num_count(numeral, n1, n2):
    ...
    Function calculate number of specified
    digits {numeral} in numbers from {n1} to {n2}
    ...
    list_of_desired_numbers = list(
        filter(
            lambda numbers: any(char == numeral_str for char in numbers), number_string
        )
    )
